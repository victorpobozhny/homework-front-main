...
export const HW2 = () => {
  ...
  console.log('!!!!!!!!!!!!!!!')
  const filterUsers = () => {
    const filteredUsers = users.myFriends.filter(function (el) { return  el.address.city == 'Los Angeles'} )//'НУЖНО ПРОФИЛЬТРОВАТЬ ДРУЗЕЙ. ОСТАВЛЯЕМ ТОЛЬКО ТЕХ, КОТОРЫЕ ЖИВУТ В ГОРОДЕ LOS ANGELES';
